...
export function IncomeList({ incomes, projectId }: { incomes: any[]; projectId: string }) {
  ...
  return (
    <div className="space-y-4">
      {incomes.map((income) => (
        <div key={income.id} className="bg-white rounded-[24px] p-5 md:p-6 border border-emerald-100 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-all hover:shadow-md">
