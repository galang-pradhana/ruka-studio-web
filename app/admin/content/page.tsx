...
const SECTION_FIELDS = {
  ...
  [LpSection.ABOUT_HERO]: [
    ...
    { key: "heroSubtitle", label: "Manifesto Teks Utama - Gunakan [kata/word] untuk efek hover", type: "textarea" as const, fallback: '{"id":"Kami adalah [kolektif arsitek] dan desainer yang percaya bahwa setiap karya arsitektur harus dimulai dengan intensi sederhana: menciptakan [ruang yang presisi], menghormati [material alami], dan merumuskan [desain berkelanjutan] demi kerangka kehidupan yang lebih baik.","en":"We are a [collective of architects] and designers who believe that every architectural work should begin with a simple intention: to create [precise space], honor [natural materials], and formulate [sustainable design] for a better framework of life."}' },
    { key: "aboutHeroImage1", label: "📷 Hover Image 1 (Kolektif Arsitek / 1st bracket)", type: "image" as const, fallback: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80" },
    { key: "aboutHeroImage2", label: "📷 Hover Image 2 (Ruang Presisi / 2nd bracket)", type: "image" as const, fallback: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80" },
    { key: "aboutHeroImage3", label: "📷 Hover Image 3 (Material Alami / 3rd bracket)", type: "image" as const, fallback: "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=800&q=80" },
    { key: "aboutHeroImage4", label: "📷 Hover Image 4 (Desain Berkelanjutan / 4th bracket)", type: "image" as const, fallback: "https://images.unsplash.com/photo-1531538606174-0f90ff5dce83?w=800&q=80" },
  ],
  [LpSection.PROCESS]: [
  ...
  [LpSection.OUR_TEAM]: [
    ...
    { key: "member1Instagram", label: "Instagram Link Anggota 1", type: "text" as const, fallback: "https://instagram.com" },
    { key: "member1Linkedin", label: "LinkedIn Link Anggota 1", type: "text" as const, fallback: "https://linkedin.com" },
    { key: "member1Email", label: "Email Anggota 1", type: "text" as const, fallback: "raka@rukastudio.com" },
    ...
    { key: "member2Instagram", label: "Instagram Link Anggota 2", type: "text" as const, fallback: "https://instagram.com" },
    { key: "member2Linkedin", label: "LinkedIn Link Anggota 2", type: "text" as const, fallback: "https://linkedin.com" },
    { key: "member2Email", label: "Email Anggota 2", type: "text" as const, fallback: "sari@rukastudio.com" },
    ...
    { key: "member3Instagram", label: "Instagram Link Anggota 3", type: "text" as const, fallback: "https://instagram.com" },
    { key: "member3Linkedin", label: "LinkedIn Link Anggota 3", type: "text" as const, fallback: "https://linkedin.com" },
    { key: "member3Email", label: "Email Anggota 3", type: "text" as const, fallback: "budi@rukastudio.com" },
    ...
    { key: "member4Instagram", label: "Instagram Link Anggota 4", type: "text" as const, fallback: "https://instagram.com" },
    { key: "member4Linkedin", label: "LinkedIn Link Anggota 4", type: "text" as const, fallback: "https://linkedin.com" },
    { key: "member4Email", label: "Email Anggota 4", type: "text" as const, fallback: "anisa@rukastudio.com" },
...
export default async function ContentPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue={LpSection.PHILOSOPHY} className="w-full">
        <div className="overflow-x-auto pb-2">
          <TabsList className="bg-white border border-gray-200 h-12 w-max sm:w-full justify-start rounded-none p-1">
            ...
            <TabsTrigger value={LpSection.ABOUT_HERO} className="rounded-none data-[state=active]:bg-[#1B3B5A] data-[state=active]:text-white">
              <FileText className="w-4 h-4 mr-2" /> Studio Kami
            </TabsTrigger>
