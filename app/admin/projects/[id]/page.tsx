  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="w-full justify-start h-auto p-1 bg-white border border-border rounded-full mb-6">
          <TabsTrigger value="overview" className="rounded-full px-6 py-2.5 data-[state=active]:bg-primary data-[state=active]:text-white">
            Ringkasan
          </TabsTrigger>
          <TabsTrigger value="terms" className="rounded-full px-6 py-2.5 data-[state=active]:bg-primary data-[state=active]:text-white">
            Termin Pembayaran
          </TabsTrigger>
          <TabsTrigger value="incomes" className="rounded-full px-6 py-2.5 data-[state=active]:bg-primary data-[state=active]:text-white">
            Pemasukan
          </TabsTrigger>
          <TabsTrigger value="expenses" className="rounded-full px-6 py-2.5 data-[state=active]:bg-primary data-[state=active]:text-white">
            Pengeluaran
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="rounded-[24px] shadow-sm border-emerald-100 bg-emerald-50/30">
            ...
            <Card className="rounded-[24px] shadow-sm border-red-100 bg-red-50/30">
              <CardHeader className="pb-2 flex flex-row items-center justify-between">
            ...
            <Card className="rounded-[24px] shadow-sm border-border bg-white">
              <CardHeader className="pb-2 flex flex-row items-center justify-between">
        ...
        <TabsContent value="terms" className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            {project.terms.length === 0 ? (
              <div className="text-center py-12 bg-white rounded-[24px] border border-border border-dashed">
